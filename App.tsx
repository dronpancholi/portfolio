...
const App: React.FC = () => {
  ...
  return (
    <div 
      className="bg-eerie-black text-alabaster selection:bg-saffron/30 min-h-screen"
      onMouseMove={(e) => {
    ...
    >
      <motion.div
        ...
        style={{
          background: `radial-gradient(800px circle at ${backgroundPositionX2} ${backgroundPositionY2}, rgba(245, 203, 92, 0.05), transparent 80%)`,
          y: bgGradientY,
        }}
      />
      <motion.div
        className="fixed top-0 left-0 w-full h-full pointer-events-none -z-10"
        style={{
          background: `radial-gradient(600px circle at ${backgroundPositionX} ${backgroundPositionY}, rgba(51, 53, 51, 0.2), transparent 80%)`,
          y: bgGradientY,
        }}
      />
      
      <motion.div 
        className="fixed inset-0 w-full h-full bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2240%22%20height%3D%2240%22%20viewBox%3D%220%200%2040%2040%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cg%20fill%3D%22%23cfdbd5%22%20fill-opacity%3D%220.03%22%20fill-rule%3D%22evenodd%22%3E%3Cpath%20d%3D%22M0%2040L40%200H20L0%2020M40%2040V20L20%2040%22%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E')] opacity-50 -z-20"
        style={{ y: bgPatternY }}
      ></motion.div>
